...
abstract class BaseTransactionTest extends TestCase
{
     ...
     * @throws \Throwable
     */
    public function simpleTransaction(): \Generator
    {
        $adapter = static::getAdapter();
     ...
     * @throws \Throwable
     */
    public function successTransactional(): \Generator
    {
        $adapter = static::getAdapter();
     ...
     * @throws \Throwable
     */
    public function transactionWithReadData(): \Generator
    {
        $adapter = static::getAdapter();
     ...
     * @throws \Throwable
     */
    public function transactionalWithDuplicate(): \Generator
    {
